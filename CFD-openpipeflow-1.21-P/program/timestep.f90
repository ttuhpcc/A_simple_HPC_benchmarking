...
!------------------------------------------------------------------------
!  Added by Jie for initialize pressure calculation
!------------------------------------------------------------------------
   subroutine tim_lumesh_inits(PM,BC,c1,c2, A)
      integer,          intent(in)  :: PM,BC
      double precision, intent(in)  :: c1,c2
      type (lumesh),    intent(out) :: A(0:i_pH1)
      double precision :: d(i_N)
   ...
   end subroutine tim_lumesh_inits
...
!-------------------------------------------------------------------------
   subroutine tim_new_tstep()
      ...
      if(tim_step==tim_steps .and. tim_corr_dt==0d0)  &
