...
!***************************************************************************
   ...
   integer,	     parameter :: i_N           = 192
   integer,          parameter :: i_K           = 1024
   integer,          parameter :: i_M           = 512
...
!-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
   ...
   integer,          parameter :: i_save_rate3  = 250 
   integer,          parameter :: i_startstep   = 0 
   integer,          parameter :: i_maxtstep    = -1
   double precision, parameter :: d_maxt        = -1d0
   double precision, parameter :: d_cpuhours    = 1.0 !90d0
